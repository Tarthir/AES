...
#x = aes.AES()
#ex = x.key_expansion([0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81,
...
#cipher_key = [0x00, 0x04, 0x08, 0x0c, 0x01, 0x05, 0x09, 0x0d, 0x02, 0x06, 0x0a, 0x0e, 0x03, 0x07, 0x0b, 0x0f]
...
compareDe_En(my_input, cipher_key, "128 BIT KEY TEST", "128_test.txt")
compareDe_En(my_input, cipher_key2, "196 BIT KEY TEST", "196_test.txt")
compareDe_En(my_input, cipher_key3, "256 BIT KEY TEST", "256_test.txt")
